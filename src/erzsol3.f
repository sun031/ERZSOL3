...
C**
      ...
      COMMON /PRESS/ RU(5,2500,3600),RV(5,2500,3600),RW(5,2500,3600)
      COMMON /STRUCT/
     &     ALSQ(500),BESQ(500),
...
C
      READ(5,*) txsfil
      ISW(10) = 2
C      open(11,file=txsfil,form='unformatted')
      open(11,file=txsfil)
...
C        WRITE(11) XS(JX),AZ(JX)*radeg,CZC,DELT,NT,PR,TCAL,SMP,
C     &            (FR(LK),LK=1,NT)
        WRITE(11,*) XS(JX),AZ(JX)*radeg,CZC,DELT,NT,PR,TCAL,SMP
        WRITE(11,*) (FR(LK),LK=1,NT)
        IF(ISW(15).GT.0) THEN
...
C        WRITE(11) XS(JX),AZ(JX)*radeg,CRC,DELT,NT,PR,TCAL,SMP,
C     &            (FR(LK),LK=1,NT)
...
C        WRITE(11) XS(JX),AZ(JX)*radeg,CTC,DELT,NT,PR,TCAL,SMP,
C     &            (FR(LK),LK=1,NT)
